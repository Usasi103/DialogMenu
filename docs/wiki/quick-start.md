...
以下按已经安装 DialogMenu、客户端能够打开现有菜单的服务器说明。0.1.21 起以 Paper 1.21.11 API 为编译基线，使用 JDK 25 构建、输出 Java 21 字节码；配套资源包声明格式 75–88（1.21.11–26.2）。首次安装及资源包自动接入见 [资源包指南](resource-pack.md)，测试环境与限制见项目 README。
